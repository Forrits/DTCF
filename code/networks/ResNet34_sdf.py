...
from .attention import rsaBlock
...
class Resnet34(nn.Module):
    def __init__(self, resnet_encoder=None, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False):
        ...
        #self.fuse1=rsaBlock(16)
        #self.fuse2=rsaBlock(32)
       # self.fuse3=rsaBlock(64)
        #self.fuse4=rsaBlock(128)
        #self.fuse5=rsaBlock(256)
        # self.fuse2=AttentionBlock(64,128)
        # self.fuse3=AttentionBlock(32,64)
    ...
    def decoder(self, features):
      ...
      #  x2=self.fuse2(x2)
        ...
        #x3=self.fuse2(x3,x5_up,x1)
        x6 = self.block_six(x5_up)
        x6_up = self.block_six_up(x6)
       # print(type(x6_up))
        x6_up = x6_up + x3
        
       # x2=self.fuse3(x2,x6_up,x1)
